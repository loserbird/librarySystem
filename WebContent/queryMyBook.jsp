...
window.onload = function() {
	...
	page.onchange = function(){
		...
		location.href="${pageContext.request.contextPath}/book?method=queryAllBook&pageNum="+pagenum;
	};
	}
...
<div>
	<c:forEach items="${pager.dataList}" var="book" varStatus="vs">
	...
	<p>
		...
		<a href="book?method=queryAllBook&pageNum=1">首页</a>&nbsp;&nbsp;
	<c:if test="${pager.previous}">
		<a href="book?method=queryAllBook&pageNum=${pager.currentPage-1}">上一页</a>&nbsp;&nbsp;
	</c:if>
	<c:if test="${pager.next}">
	<a href="book?method=queryAllBook&pageNum=${pager.currentPage+1}">下一页</a>&nbsp;&nbsp;
	</c:if>
	<a href="book?method=queryAllBook&pageNum=${pager.totalPage }">尾页</a>&nbsp;&nbsp;
		跳到第<select id="page">
